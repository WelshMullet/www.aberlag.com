...
### Mission 6 - Saturday - FINAL DAY

#### PLOT TWIST:

Respawns are allowed - run to your briefing area immediately after your death to respawn. Teams will be informed about where specifically they must respawn.
We are putting a lot of trust in you guys, as us mods will be needed for the control points. Don't make us regret it.

##### BEFORE THE MISSION

Both teams begin from their respective briefing areas. They are to arrive there at 16.10. They will be briefed on the objectives and rules of the mission. These areas are SAFE ZONES until the mission begins and immediately after the mission ends.

##### MISSION OBJECTIVES

Capture as many of the 5 points as possible!
<br/> <a href="https://maps.google.com/maps/ms?ie=UTF&msa=0&msid=200052748815827666935.0004d6be6b1b5ed4ea399">Map</a>

##### SCORING

2 points for each point captured.

##### NOTES

- A point is captured by touching the mod for a full minute. If contact is broken, 60 second timer is reset. After completing a capture, it takes 10 minutes for the point to become permanently assigned to your team and uncapturable by the enemy team. If the enemy team manages to take away the point(i.e., touch the mod for 60 seconds) during these 10 minutes, the timer is reset back to ten minutes.
- While capturing, you are discouraged from using the mod as cover from enemy fire; the mods will think of suitable punishment for each shot to the face they endure as a result of your cowardice.
